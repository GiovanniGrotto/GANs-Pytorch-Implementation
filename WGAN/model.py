    ...
    for batch_idx, (data, _) in enumerate(loop):
        ...
        for _ in range(critic_it):
            ...
            for p in disc.parameters():
                # Here we are clipping all the weight between -0.01 and 0.01
                # this makes the function Lipschitz continuous and it's needed for convergence, this method
                # is pretty bad since it influence the weight and the learning, gradient penalty is a better alternative
